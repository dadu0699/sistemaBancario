...
public class AutoBankOperations extends Stage {
    private static AutoBankOperations instance;
    private HBox hBoxPanels;
    private VBox vBoxPanels;
    private ObservableList observableList;

    private AutoBankOperations() {
    }

    public static AutoBankOperations getInstance() {
        if (instance == null) {
            instance = new AutoBankOperations();
        }
        return instance;
    }
    ...
    private void updateObservableList() {
        AutoBank[] bankingAutoBank = ControllerAutoBank.getInstance().getAutoBanks();
        ArrayList<AutoBank> arrayListBankingAgency = new ArrayList<>();
        for (AutoBank agency : bankingAutoBank) {
            if (agency != null) {
    ...
    private GridPane getGridPanePayOffice() {
        ...
        Text textTitle = new Text("CAJAS / CAJAS AUTOBANCO");
        textTitle.getStyleClass().add("textTitle");
